 ...
 */
final class Version20230923110007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        (
        id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, 
        ...
        (
        id INT AUTO_INCREMENT NOT NULL, name VARCHAR(65) NOT NULL, 
